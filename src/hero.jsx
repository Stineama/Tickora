        ...
        <div className="relative mx-auto w-full max-w-lg lg:justify-self-end">
          <div className="overflow-hidden rounded-4xl border border-white/15 bg-white/10 p-3 shadow-2xl shadow-black/50 backdrop-blur-xl">
            <div className="relative overflow-hidden rounded-3xl">
              <img
                src="https://images.unsplash.com/photo-1594122107402-e0a8ede4655d?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NTh8fExhZ29zJTIwbmlnaHQlMjBNdXNpYyUyMEZlc3RpdmFsfGVufDB8fDB8fHww"
